return {
	...
	config = function()
		vim.diagnostic.config({
			signs = {
				...
				values = {
					...
					[vim.diagnostic.severity.HINT] = { text = "󰌵", texthl = "DiagnosticSignHint" },
				},
			},
		})
		...
		vim.api.nvim_set_keymap("n", "<C-a>", ":Neotree toggle<CR>", { noremap = true, silent = true })
		vim.api.nvim_set_keymap("n", "<C-l>", ":Neotree reveal<CR>", { noremap = true, silent = true })
